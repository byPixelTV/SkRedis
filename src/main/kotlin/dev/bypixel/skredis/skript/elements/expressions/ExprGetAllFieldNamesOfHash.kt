...
class ExprGetAllFieldNamesOfHash : SimpleExpression<String>() {
    fun register() {
        SkRedis.instance.addon.syntaxRegistry().register(
            ...
            DefaultSyntaxInfos.Expression.builder(ExprGetAllFieldNamesOfHash::class.java, String::class.java)
                .origin(Origin.of(SkRedis.instance.addon))
                .supplier { ExprGetAllFieldNamesOfHash() }
                .addPattern("all field names of redis hash %string%")
                .build()
        )
    }
    ...
    override fun get(e: Event?): Array<String>? {
        ...
        if (hashKey != null) {
            return SkRedis.instance.lettuceClient.sync.hkeys(hashKey).toTypedArray()
        }
        return null
    }
